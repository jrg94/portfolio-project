...
While I originally wanted to do the QB stats idea, I decided that I wanted to move
forward with that idea as a passion project. With the portfolio project, I believe that
moving forward with the music playlist design would be best. Both ideas would be similar,
but I would have more interest while implementing these kernel methods.
...
Here `2025.10.09` would be the date of your submission, such as 2024.04.21.
