...
With that said, these criteria will not be overly strict as you are
...
- Component Design #1: <!-- TODO: brainstorm a component and delete this comment -->
  - **Description**:
  - **Kernel Methods**:
  - **Secondary Methods**:
- Component Design #2: <!-- TODO: brainstorm a component and delete this comment -->
  - **Description**:
  - **Kernel Methods**:
  - **Secondary Methods**:
- Component Design #3: <!-- TODO: brainstorm a component and delete this comment -->
  - **Description**:
  - **Kernel Methods**:
  - **Secondary Methods**:
