...
| Students should be able to generate client-sided documentation for their component | Factual Creation         | 3      | (0) No attempt is made to generate documentation       | (1) Documentation is included but does not follow expectations from our discipline (e.g., no OSU-specific annotations) | (2) Documentation is included bZ                                                   |
| Students should be able to design kernel and enhanced interfaces                   | Procedural Creation      | 3      |
